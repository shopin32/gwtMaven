...
public class DisabledCheckboxCell extends AbstractEditableCell<Boolean,Boolean> {
	 ...
	 */
	public DisabledCheckboxCell(boolean isSelectBox) {
	 ...
	 */
	public DisabledCheckboxCell(boolean dependsOnSelection, boolean handlesSelection) {
		super(BrowserEvents.CHANGE, BrowserEvents.KEYDOWN);
		this.dependsOnSelection = dependsOnSelection;
		this.handlesSelection = handlesSelection;
	}
	CheckBox cb; 
	public DisabledCheckboxCell(boolean dependsOnSelection, boolean handlesSelection, CheckBox cb){
	...
	public void render(Context context, Boolean value, SafeHtmlBuilder sb) {
		...
		if(cb !=null && cb.getValue()&& value)
		{
			sb.append(INPUT_CHECKED_DISABLED);
		}else if(cb !=null && cb.getValue()&& !value){
			sb.append(INPUT_UNCHECKED_DISABLED);
		}else if(value != null && ((viewData != null) ? viewData : value)) {
